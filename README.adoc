...
----
compile 'com.rnbwarden.redisearch:jredisearch-spring-boot-starter:10.X.Y'
----
...
----
    ...
    compile 'com.redislabs:jredisearch:1.7.0'
----
...
----
    compile 'org.springframework.data:spring-data-redis:2.2.6.RELEASE'
    compile 'com.redislabs:lettusearch:2.3.2'
    compile ('com.redislabs:spring-redisearch:2.3.2') {
