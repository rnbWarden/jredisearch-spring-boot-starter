...
----
compile 'com.rnbwarden.redisearch:jredisearch-spring-boot-starter:6.0.0'
----
...
----
    compile 'org.springframework.data:spring-data-redis:2.2.5.RELEASE'
...
----
    compile 'org.springframework.data:spring-data-redis:2.2.5.RELEASE'
    compile 'com.redislabs:lettusearch:1.13.0'
    compile ('com.redislabs:spring-redisearch:1.12.8') {
