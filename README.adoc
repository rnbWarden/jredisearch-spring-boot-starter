...
----
compile 'com.rnbwarden.redisearch:jredisearch-spring-boot-starter:5.2.5'
----
...
----
    ...
    compile 'com.redislabs:jredisearch:1.1.0'
----
...
----
    ...
    compile ('com.redislabs:spring-redisearch:1.6.0') {
